...
var KisBpmAssignmentCustomerRolePopupCtrl = [ '$scope', '$http', function($scope, $http) {
    ...
    $scope.initializeController = function () {
        ...
        $http({method: 'GET', url: 'role/list?currentPage=' + $scope.currentPageNum + '&pageSize=' + $scope.pageSize})
    ...
    $scope.rebuildData = function(content) {
        return 'r_' + content.id + '_' + content.description + '_' + content.name;
    };
